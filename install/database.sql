...
(28, 'contract', 'send-contract', 'english', 'Send Contract to Customer', 'Contract - {contract_subject}', '<p><span style=\"font-size: 12pt;\">Hi&nbsp;{contact_firstname}&nbsp;{contact_lastname}</span><br /><br /><span style=\"font-size: 12pt;\">Please find the {contract_subject} attached.</span><br /><br /><span style=\"font-size: 12pt;\">Looking forward to hear from you.</span><br /><br /><span style=\"font-size: 12pt;\">Kind Regards,</span><br /><span style=\"font-size: 12pt;\">{email_signature}</span></p>', '{companyname} | CRM', '', 0, 1, 0),
...
(245, 'show_project_on_invoice', '1', 1),
(246, 'show_project_on_estimate', '1', 1),
(247, 'visible_customer_profile_tabs', 'all', 0),
(248, 'staff_members_create_inline_lead_status', '1', 1),
(249, 'staff_members_create_inline_lead_source', '1', 1),
(250, 'staff_members_create_inline_customer_groups', '1', 1),
(251, 'staff_members_create_inline_ticket_services', '1', 1),
(252, 'staff_members_save_tickets_predefined_replies', '1', 1),
(253, 'staff_members_create_inline_contract_types', '1', 1),
(254, 'staff_members_create_inline_expense_categories', '1', 1),
(255, 'show_project_on_credit_note', '1', 1),
(256, 'proposals_auto_operations_hour', '21', 1),
(257, 'estimates_auto_operations_hour', '21', 1),
(258, 'contracts_auto_operations_hour', '21', 1);
...
CREATE TABLE `tblstaff` (
  ...
  `dashboard_widgets_order` text,
  `dashboard_widgets_visibility` text
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `tblemailtemplates`
  MODIFY `emailtemplateid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
--
